...
\subsubsection{Solving Outline}
\begin{enumerate}
\item find the mols of acid and base
\item find the amount of unchanges acid ($n_{acid} - n_{base}$)
\item find the concentration ($\frac{n_{unchanged}}{volume}$)
\item find pH given the concentration (log)
\end{enumerate}
...
\captionof{figure}{Notes directly from Gueli stuff}
\end{figure}
